...
//    public void Add()
//    {
//        if (rabbitState != rabbitState.Normal) return;
...
//    {
//        rabbitState = rabbitState.Transforming;
//        Eating = false;
...
//        rabbitState = rabbitState.Normal;
//        // HPをセット
//        currentHP = maxHP;
//    }
...
//    {
//        // 通常状態のうさぎは、ダメージを受けない
//        if (rabbittState != rabbitState.Monster) return;
